    ...
    /******/
        ...
        $(document).ready(function () {
            ...
            $('body').on('click', '#add_subject', function (e) {
                ...
                var validation_filed_array = ['title', 'sub_title', 'sub_title_two', 'title_section_one', 'main_subject'];
                ...
                if (profile_avatar.length == 1) {
                    ...
                    if (Extension == 'jpg' || Extension == 'png' || Extension == 'gif' || Extension == 'jpeg') {
                        ...
                        $('.subject_image_error').html("Image only allows image types of PNG, JPG, JPEG");
                        validation_status = 1;
                    }
                }
                else {
                ...
                $('input[name="section_one_title_more[]"]').each(function (e) {
                    ...
                    if (title.trim() == '') {
                        $('.section_one_title_more' + dataId + '_error').addClass('is-invalid').removeClass('is-valid');
                        $('.section_one_title_more' + dataId + '_error').html(dataMSG + ' is required.');
                        validation_status = 1;
                    }
                    else {
                        $('.section_one_title_more' + dataId + '_error').addClass('is-valid').removeClass('is-invalid');
                        $('.section_one_title_more' + dataId + '_error').html("");
                    }
                })
                ...
                $('input[name="link_more[]"]').each(function (e) {
                    ...
                    if (title.trim() == '') {
                        ...
                        $('.link_more' + dataId + '_error').html(dataMSG + ' is required.');
                        validation_status = 1;
                    }
                ...
                $('input[name="title_section_two[]"]').each(function (e) {
                    ...
                    var dataMSG = $(this).attr('data-msg');
                    if (title.trim() == '') {
                        $('.title_section_two' + dataId + '_error').addClass('is-invalid').removeClass('is-valid');
                        $('.title_section_two' + dataId + '_error').html(dataMSG + ' is required.');
                        validation_status = 1;
                    }
                    else {
                        $('.title_section_two' + dataId + '_error').addClass('is-valid').removeClass('is-invalid');
                        $('.title_section_two' + dataId + '_error').html("");
                    }
                })
            ...
            $('body').on('click', '.delete-category', function (e) {
                ...
                $.confirm({
                    ...
                    content: "you want to delete this sub subject?",
                    buttons: {
                        formSubmit: {
                            text: 'Submit',
                            btnClass: 'btn-danger',
