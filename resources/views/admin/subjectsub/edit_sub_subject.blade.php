                    ...
                    <div class="card card-custom card-stretch">
                        ...
                        <div class="card-header py-3">
                            <div class="card-title align-items-start flex-column">
                                <h3 class="card-label font-weight-bolder text-dark">Edit Sub Subject</h3>
                            </div>
                        </div>
                    
                        <form class="form" id="submitid" method="post" action="{{url('sub-subject-master')}}/{{$basic_details->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                                                    ...
                                                    <div class="scopy_id" id="{{ $uniqid }}">
                                                        <div class="row">
                                                            <div class="col-md-6 mb-4">
                                                                <div class="form-group">
                                                                    <label> @if($key ==0) Title <span class="text-danger">*</span> @endif</label>
                                                                    <input placeholder="Title" class="form-control validate_field section_one_title_more{{ $uniqid }}_error" data-id="{{ $uniqid }}" autocomplete="off" id="section_one_title{{ $uniqid }}" type="text" data-msg="Section One Title" name="section_one_title_more[]" value="{{$val->title}}">
                                                                    <span class="form-text error section_one_title_more{{ $uniqid }}_error"></span>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-5 mb-4">
                                                                <div class="form-group">
                                                                    <label>@if($key ==0) Link <span class="text-danger">*</span> @endif</label>
                                                                    <input placeholder="Link" class="form-control validate_field link_more{{ $uniqid }}_error" autocomplete="off" data-id="{{ $uniqid }}" id="link_more{{ $uniqid }}" type="text" data-msg="Link" name="link_more[]"  value="{{$val->link}}">
...
<script>
    ...
    function addMoreSolutionSectionTwo() {
        ...
        var htmls = '<div class="scopy_id_sec" id="' + length + '">' +
            '<div class="row">' +
            '<div class="col-md-6 mb-4"><div class="form-group"><input placeholder="Title" class="form-control validate_field title_section_two'+uniqid+'" autocomplete="off" data-id="'+uniqid+'" id="title_section_two'+uniqid+'" type="text" data-msg="Title Section Two" name="title_section_two[]"><span class="form-text error title_section_two'+uniqid+'_error"></span> </div></div>' +
