                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="author_name" class="form-control" value="" id="author-add" placeholder="Author Name">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="author_name" class="form-control" data-msg="author_name" value="author_name" id="author-edit" placeholder="Author Name">
