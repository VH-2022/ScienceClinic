                        ...
                        <div class="card-header py-3">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="dropdown dropdown-inline mr-2">
                                    ...
                                    <button id="kt_demo_panel_toggle" type="button"
                                        class="btn btn-light-primary font-weight-bolder" data-toggle="dropdown"
                                ...
                                <a href="javascript:void(0)" class="btn btn-primary mr-2" id="create-new"
                                    data-toggle="modal" data-target="#testimonial-modal" title="Add Testimonial">
        ...
        <div class="offcanvas-content">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    ...
                    <input class="form-control" placeHolder="Search Author Name" type="text" name="author_name"
                        id="author_name">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    ...
                    <input class="form-control" placeHolder="Search Description" type="text" name="description"
                        id="description">
                ...
                <form id="testimonialForm" name="testimonialForm" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="name" class="col-md-4 col-form-label">Author Name<span
                                    class="text-danger">*</span></label>

                            <div class="col-md-12">

                                <input type="text" name="author_name" class="form-control" value="" id="author-add"
