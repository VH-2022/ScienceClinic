                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="title" class="form-control charCls" value="" id="title-add" placeholder="Enter Name" maxlength="100">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="title" class="form-control charCls" value="" id="title-edit" placeholder="Enter Name" maxlength="100">
