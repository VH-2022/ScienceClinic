...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4 scroll ps ps--active-y" data-menu-vertical="1"
            data-menu-scroll="1" data-menu-dropdown-timeout="500" style="height: 285px; overflow: hidden;">
            <!--begin::Menu Nav-->
            <ul class="menu-nav">
                <li class="menu-item {{ Request::segment(1) == 'admin' ? 'menu-item-active' : '' }}"
                    aria-haspopup="true">
                ...
                @endphp
                <li class="menu-item menu-item-submenu @if ($subjectFlag == 1) menu-item-open @endif"
                    ...
                    <div class="menu-submenu" kt-hidden-height="80">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ Request::segment(1) == 'subject-master' ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                            ...
                            <li class="menu-item {{ Request::segment(1) == 'sub-subject-master' ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                ...
                @endphp
                <li class="menu-item menu-item-submenu @if ($tutorFlag == 1) menu-item-open @endif"
                    aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Design/Bucket.svg-->
                    ...
                    <div class="menu-submenu" kt-hidden-height="80">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ Request::segment(1) == 'tutor-level' ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                            ...
                            <li class="menu-item {{ Request::segment(1) == 'tutor-master' ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
