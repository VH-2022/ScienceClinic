                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-3">
                        ...
                        <div class="card-title align-items-start flex-column">
                            ...
                            <h3 class="card-label font-weight-bolder text-dark">Past Papers List</h3>
                        ...
                        <div class="card-toolbar">
                            ...
                            <a href="{{route('tutor-past-papers.create')}}" class="btn btn-primary mr-2">
...
<script>
    ...
    var _AJAX_LIST = "{{url('tutor-past-papers-ajax-list')}}";

    var _DELETE_URL = '{{ url("tutor-past-papers")}}';
