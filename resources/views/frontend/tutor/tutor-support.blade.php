...
<div class="modal fade" id="ajax-crud-modal" aria-hidden="true">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('tutor-support-ticket.store') }}" method="post" id="subjectForm" name="userForm" class="form-horizontal">
...
<div class="modal fade title-edit" id="editajax-crud-modal" aria-hidden="true">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('tutor-support-ticket.update','1') }}" id="formEdit" name="formEdit" class="form-horizontal" Method="post">
...
<script>
    var id = $('#editid').val();
    var _AJAX_LIST = "{{ route('tutor-support-ajax') }}";
    var _GET_DATA_TICKET = "{{ url('tutor-support-ticket') }}/" + id;
    var _DELETE_TICKET = "{{ route('tutor-support-ticket.destroy','') }}";
    ...
    $(document).ready(function() {
        ...
        <?php if (Request::get('editpopup') == '1') { ?>
            ...
            $.ajax({
                async: false,
                global: false,
                url: "{{ url('tutor-support-edit') }}/" + edit,
                type: "GET",
