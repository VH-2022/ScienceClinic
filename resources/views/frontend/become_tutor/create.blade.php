                                    ...
                                    <div class="text-content text-center-content">
                                        ...
                                        <h1 class="title1 text-center max-englishtext mb-20">
                                            ...
                                            <span class="tlt block" data-in-effect="fadeInRight"
                                                data-out-effect="fadeOutRight">Become a Tutor</span>
                        ...
                        <div>
                            ...
                            <div class="single-item-text">
                                ...
                                <div class="contact-form-area">
                                    ...
                                    <form action="{{ route('become-tutor.store') }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <span class="text-danger"
                                                    id="error_name">{{ $errors->useredit->first('name') }}</span>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <span class="text-danger"
                                                    id="error_email">{{ $errors->useredit->first('email') }}</span>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <span class="text-danger"
                                                    id="error_mobile">{{ $errors->useredit->first('mobile') }}</span>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <span class="text-danger"
                                                    id="error_address1">{{ $errors->useredit->first('address1') }}</span>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <span class="text-danger"
                                                    id="error_address2">{{ $errors->useredit->first('address2') }}</span>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <span class="text-danger"
                                                    id="error_address3">{{ $errors->useredit->first('address3') }}</span>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <span class="text-danger"
                                                    id="error_city">{{ $errors->useredit->first('city') }}</span>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <span class="text-danger"
                                                    id="error_postcode">{{ $errors->useredit->first('postcode') }}</span>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <span class="text-danger"
                                                    id="error_bio">{{ $errors->useredit->first('bio') }}</span>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <input name="university[]"
                                                                        data-id="{{ $uniqid }}" type="text"
                                                                        placeholder="University/Institution">

                                                                    <span id="customer_name_{{ $uniqid }}_error"
                                                                        class="text-danger">{{ $errors->useredit->first('university') }}</span>
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <span id="qualification{{ $uniqid }}_error"
                                                                        class="text-danger">{{ $errors->useredit->first('qualification') }}</span>
                                                                    ...
                                                                    <div class="downloaded-file position-relative">
                                                                        ...
                                                                        <div class="chemistry-icon-text">
                                                                            <div class="input-file-bio">
                                                                                <p type="text" id="uploadeviFile"
                                                                                    class="input-upload-bio"> </p>
                                                                            </div>

                                                                            <input type="file" name="document_certi[]"
                                                                                data-id="{{ $uniqid }}"
                                                                                class="bio-input-fild" id="uploadeviBtn">

                                                                            <span
                                                                                id="document_certi{{ $uniqid }}_error"
                                                                ...
                                                                <div class="col-md-2 add"> <a
                                                                        class="extra-fields-customer search-menu"
                                                                        href="javascript:void(0)"><i
                                                                            class="fa fa-plus fa-icon"
                                                                            aria-hidden="true" style="margin-top: 4px;"></i></a></div>
                                                ...
                                                <div class="customer_records position-relative">
                                                    <div id="subjects_id">
                                                        ...
                                                        <div class="copy_subject_id" id="{{$uniqid}}">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <select class="selectpicker" data-id="{{$uniqid }}" name="subject[]" aria-label="Default select example" data-live-search="true">
                                                                    ...
                                                                    <span class="text-danger"
                                                                        id="subject_{{$uniqid}}_error">{{ $errors->useredit->first('subject') }}</span>

                                                                </div>
                                                                <div class="col-md-5">
                                                                    <select class="selectpicker" data-id="{{$uniqid }}" name="level[]" multiple
                                                                    ...
                                                                    <span class="text-danger"
                                                                        id="level_{{$uniqid }}_error">{{ $errors->useredit->first('level') }}</span>
                                            ...
                                            <div class="col-md-12 row" style="margin-top: 2%;">
                                                <div class="col-md-6 mb-23">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <input type="radio" id="customRadio2" value="Yes" name="dbsdisclosure"
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <input type="radio" id="customRadio3" name="dbsdisclosure"
                                                            class="custom-control-input" value="No" onclick="show1();">
                                                    ...
                                                    <span class="text-danger"
                                                        id="dbsdisclosure_error">{{ $errors->useredit->first('dbsdisclosure') }}</span>
                                                    ...
                                                    <div id="div1" class="hide">
                                                        ...
                                                        <div class="main-file-box">
                                                            ...
                                                            <div class="file-flex">
                                                                ...
                                                                <input class="blank-input file-input-box" id="uploadFile"
                                                                    type="text">
                                                            ...
                                                            <div class="main-file-uplode">
                                                                ...
                                                                <div class="upload-img-box">
                                                                    ...
                                                                    <img src="{{ asset('front/img/upload.png') }}"
                                                ...
                                                <div class="col-md-6 mb-23">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <input type="radio" id="customRadio4" value="Yes" name="exprienceinuk"
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <input type="radio" id="customRadio5" name="exprienceinuk"
                                                    ...
                                                    <span class="text-danger"
                                                        id="exprienceinuk_error">{{ $errors->useredit->first('exprienceinuk') }}</span>
                                                ...
                                                <div class="col-md-6 mb-23">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <input type="radio" id="customRadio6" name="tutorexperienceinuk"
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <input type="radio" id="customRadio7" name="tutorexperienceinuk"
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <input type="radio" id="customRadio8" name="tutorexperienceinuk"
                                                    ...
                                                    <span class="text-danger"
                                                        id="tutorexperienceinuk_error">{{ $errors->useredit->first('tutorexperienceinuk') }}</span>
                                                ...
                                                <div class="col-md-6 mb-23">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <input type="radio" id="customRadio11" value="Yes" name="paytax"
                                                            class="custom-control-input">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <input type="radio" id="customRadio10" value="No" name="paytax"
                                                            class="custom-control-input">
                                                    ...
                                                    <span class="text-danger"
                                                        id="paytax_error">{{ $errors->useredit->first('paytax') }}</span>
                                            ...
                                            <div class="col-md-2 mb-23">
                                                ...
                                                <div class="avatar-upload">
                                                    ...
                                                    <div class="avatar-preview">
                                                        ...
                                                        <div id="imagePreview"
                                                            style="background-image: url({{ asset('img/tutors/1.jpg') }});">
                                                ...
                                                <span class="text-danger"
                                                    id="profile_pic_error">{{ $errors->useredit->first('profile_image') }}</span>
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="form-check custom-check">
                                                    ...
                                                    <input class="form-check-input terms-condition" type="checkbox"
                                                        value="1" name="term" id="term">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="become-end-btn btn-end">
                                                    ...
                                                    <button type="submit" id="submitform"
                                                        class="button-default">SUBMIT</button>
...
@section('page-js')
    ...
    <script>
        ...
        $("#formdata").submit(function() {
            ...
            $('select[name="subject[]"]').each(function(e) {
                var dataId = $(this).attr('data-id');
            ...
            $('select[name="level[]"]').each(function(e) {
                var dataId = $(this).attr('data-id');
                var dataValue = $(this).val();
        ...
        function addmoreSubject(){
            ...
            htmlRep +='<div class="copy_subject_id" id="'+mathRandSubject+'" style="margin-top: 10px;">'+
                    '<div class="row">'+
                        '<div class="col-md-6">'+
                            
                                '<select class="selectpicker" name="subject[]" data-id="'+mathRandSubject+'" aria-label="Default select example" data-live-search="true">'+dropdowns+'</select>'+
                                '<span class="text-danger" id="subject_'+mathRandSubject+'_error"></span></div>'+
                                '<div class="col-md-5"><select class="selectpicker" data-id="'+mathRandSubject+'" name="level[]" multiple aria-label="Default select example" data-live-search="true">'+level_id+'</select><span class="text-danger" id="level_'+mathRandSubject+'_error"></span></div>'+
